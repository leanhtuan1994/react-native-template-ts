 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.caracal.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.caracal'; // ios bundle id
const PACKAGE = 'com.caracal'; // android package name
const NAME = 'CaracalApp'; // app name
const EXPO_ACCOUNT_OWNER = 'leanhtuan1994'; // expo account owner
const EAS_PROJECT_ID = 'c3e1075b-6fe7-4686-aa49-35b46a229044'; // eas project id
const SCHEME = 'caracalApp'; // app scheme
