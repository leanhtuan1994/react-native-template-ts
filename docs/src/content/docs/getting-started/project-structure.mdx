...
- `components/ui`: This folder contains all the UI components and the theme configuration. We provide minimal components based on HeroUI Native and Uniwind. You can add your own components and theme configuration here.
