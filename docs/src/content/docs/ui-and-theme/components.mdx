...
The starter comes with a set of basic components and a simple design system based on Uniwind and HeroUI Native to help you get started and save you time.
...
![Create component](https://github.com/leanhtuan1994/react-native-template-atlas/assets/11137944/ca84555f-12b7-4048-98b8-3c8391bd9918)
:::
...
The `withUniwind` function from `uniwind` is used to apply styling and, in this way, the `className` property is applied to the `style` property of the `Image` component.
