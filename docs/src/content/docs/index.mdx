---
title: Atlas Starter | React Native/Expo starter
...
hero:
  ...
  actions:
    - text: Get Started
      ...
      variant: primary
    - text: Hire Me
      link: https://leanhtuan1994.github.io/contact
      icon: external
      variant: secondary
---
...
In addition to maintaining this starter kit, I'm available for custom projects and app development consulting. If you're looking for an experienced React Native developer to bring your app vision to life, feel free to reach out.

[Contact Me](https://leanhtuan1994.github.io/contact)
