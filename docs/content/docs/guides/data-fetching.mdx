...
To reduce boilerplate and improve type safety, Caracal uses [react-query-kit](https://github.com/liaoliao666/react-query-kit) — a thin toolkit that makes React Query hooks reusable and strongly typed.
