...
Atlas uses **Expo Router** with the following features enabled:
...
Atlas includes 30 component showcase routes in the `(components)` group — interactive examples demonstrating HeroUI Native components.
