---
title: Forms
description: Complete guide to handling forms with react-hook-form, Zod validation, and keyboard management in Caracal starter.
---
...
1. **[react-hook-form](https://react-hook-form.com/)** — Form state management
2. **[Zod](https://zod.dev/)** — Schema validation with TypeScript inference
3. **[react-native-keyboard-controller](https://kirillzyusko.github.io/react-native-keyboard-controller/)** — Keyboard handling
...
- Works seamlessly with [HeroUI Native](/docs/ui-and-theme/heroui-native) components
