...
While most UI components come from [HeroUI Native](/docs/ui-and-theme/heroui-native), the Atlas starter includes a small set of custom components designed for specific needs not covered by the UI library.
