...
Atlas uses [HeroUI Native](https://v3.heroui.com/native) (v1.0.4) as the primary UI component library, providing 30+ production-ready components with built-in accessibility, theming, and styling.
...
<Callout type="info">
Always refer to the [official documentation](https://v3.heroui.com/native) for the latest updates.
</Callout>
...
See [Forms documentation](/docs/ui-and-theme/forms) for complete form handling patterns.
...
See [Component Showcase Guide](/docs/ui-and-theme/component-showcase) for detailed documentation on using showcases as learning resources.
...
- **Custom Components:** See [Custom Components Guide](/docs/ui-and-theme/custom-components)
- **Styling Guide:** See [UI & Theming](/docs/ui-and-theme/ui-theming)
- **Forms Integration:** See [Forms Guide](/docs/ui-and-theme/forms)
...
- **HeroUI Native:** 1.0.4
- **React Native Compatibility:** 0.85.3+
- **React Version:** 19+
- **Expo SDK:** 56
- **Uniwind Version:** 1.6.3

**Next Steps:**
- Explore [Custom Components](/docs/ui-and-theme/custom-components) for specialized components
- Learn about [Component Showcases](/docs/ui-and-theme/component-showcase) for interactive examples
- Read [Forms documentation](/docs/ui-and-theme/forms) for form handling patterns
