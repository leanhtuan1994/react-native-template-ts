...
description: Guide to using HeroUI Native as the primary UI component library in Caracal starter.
---

Caracal uses [HeroUI Native](https://v3.heroui.com/native) (v1.0.5) as the primary UI component library, providing 30+ production-ready components with built-in accessibility, theming, and styling.
