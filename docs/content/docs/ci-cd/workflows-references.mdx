...
description: Complete reference for all 14 GitHub Actions workflows and 3 custom actions included in Caracal.
---
...
- [App Releasing Process](/docs/ci-cd/app-releasing-process)
- [CI/CD Overview](/docs/ci-cd/overview)
