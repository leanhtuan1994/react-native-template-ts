...
description: All you need to know about the CI/CD setup in Caracal.
---
...
As most projects are hosted on GitHub, Caracal uses [GitHub Actions](https://github.com/features/actions) and [Expo EAS](https://expo.dev/eas) as the CI/CD solution. The starter kit comes with over 14 GitHub Actions workflows:
...
Pushing a new release to the stores is a regular process. To make it easier, Caracal provides a simple process using GitHub Actions and Expo EAS. You can check the full guide in the [App Releasing Process](/docs/ci-cd/app-releasing-process).
