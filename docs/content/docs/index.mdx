---
title: Introduction
description: An overview of why we built the Caracal starter, its features, and the libraries used.
---
...
This starter is maintained by [Tuan Anh Le](https://leanhtuan1994.github.io/team) and new contributors are welcome. If you're interested in getting involved, please don't hesitate to open an issue or submit a pull request on [GitHub](https://github.com/leanhtuan1994/react-native-caracal).

## FAQ

If you have any questions about the starter, please open an [issue](https://github.com/leanhtuan1994/react-native-caracal/issues) or visit the [FAQ](/docs/reference/faq).
