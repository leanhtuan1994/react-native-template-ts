...
- **Latest Expo SDK 56** with Custom Dev Client: Leverage the best of the Expo ecosystem while maintaining full control over your app.
...
- [Expo Router v6](https://docs.expo.dev/router/introduction/) with **typed routes** and route groups for type-safe, file-based navigation.
...
- [React Native](https://reactnative.dev/) 0.85.3 with [New Architecture](https://reactnative.dev/docs/new-architecture-intro)
- [Expo SDK](https://docs.expo.dev/) 56.0.12
- [TypeScript](https://www.typescriptlang.org/) 5+

### Navigation & Routing

- [Expo Router](https://docs.expo.dev/router/introduction/) v6 (typed routes enabled)

### UI & Styling

- [HeroUI Native](https://v3.heroui.com/docs/native/getting-started) 1.0.4 (30+ components)
- [Uniwind](https://docs.uniwind.dev/) 1.6.3 (TailwindCSS for React Native)
...
This starter is maintained by [Tuan Anh Le](https://leanhtuan1994.github.io/team) and new contributors are welcome. If you're interested in getting involved, please don't hesitate to open an issue or submit a pull request on [GitHub](https://github.com/leanhtuan1994/react-native-template-atlas).

## FAQ

If you have any questions about the starter, please check out the [Discussions](https://github.com/leanhtuan1994/react-native-template-atlas/discussions) page or visit the [FAQ](/docs/reference/faq).
