...
description: Complete guide to the Caracal starter project structure, file organization, and architectural patterns.
---
...
// Subscribe only to the state each component needs
...
- `openLinkInBrowser` - Safely opens supported URLs
...
- Shared app icon assets for every environment
