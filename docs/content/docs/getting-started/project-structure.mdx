...
**Important:** For buttons, cards, dialogs, and other standard UI, use [HeroUI Native components](https://v3.heroui.com/native/llms-full.txt) instead.
...
See [Data Fetching guide](/docs/guides/data-fetching) for complete patterns.
...
See [Internationalization guide](/docs/guides/internationalization) for usage.
...
See [Environment Variables guide](/docs/getting-started/environment-vars-config) for configuration.
...
See [Environment Variables guide](/docs/getting-started/environment-vars-config) for complete setup.
...
TailwindCSS configuration for React Native via Uniwind (v1.6.3):
...
See [UI & Theming guide](/docs/ui-and-theme/ui-theming) for styling.
...
- [Environment Variables](/docs/getting-started/environment-vars-config) - Multi-environment setup
- [Rules and Conventions](/docs/getting-started/rules-and-conventions) - Code standards
- [Navigation](/docs/guides/navigation) - Routing and navigation patterns
