...
description: Let's create a new React Native project with Caracal starter.
---

Let's create a new React Native project with Caracal starter.
...
Start your project using `create-caracal-app` command:
